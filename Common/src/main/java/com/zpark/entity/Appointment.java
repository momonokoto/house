...
public class Appointment implements Serializable {
     ...
     */
    @TableField("date")
    @Schema(description = "预约时间", requiredMode = Schema.RequiredMode.REQUIRED, example = "2025-04-27 12:00")
    ...
    @Schema(description = "预约创建时间", accessMode = Schema.AccessMode.READ_ONLY)
