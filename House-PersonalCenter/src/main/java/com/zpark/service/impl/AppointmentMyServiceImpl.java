...
public class AppointmentMyServiceImpl extends ServiceImpl<IAppointmentMyMapper, Appointment> implements IAppointmentMyService {
    ...
    @Autowired
    private IAppointmentMyMapper appointmentMyMapper;
    @Override
    public Page<Appointment> findAll(Integer currentPage,Integer pageSize, HttpServletRequest request) {
        ...
        Page<Appointment> appointmentPage = new Page<>(currentPage, pageSize);
        return appointmentMyMapper.selectPage(appointmentPage, lambdaQueryWrapper);
    }
}
